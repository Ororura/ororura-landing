...
const initialState: InitialStateType = {
  posts: [
    ...
    {
      id: 3,
      title: "Попробовать себя в чём-то другом?",
      text: `Я слишком устал от однотипного Front end'а. Постоянно выходят новые фрэймворки, постоянно нужно учить "что-то новое". Как же прекрасно быть Java-разработчиком.`,
      date: "25.12.2024",
    }
  ],
};
