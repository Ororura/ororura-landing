...
const RelicInsignia: FC<RelicInsigniaProps> = ({ isAwake }) => {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <svg aria-hidden="true" className="relative h-[78%] w-[78%] text-[#d3c4ab]" viewBox="0 0 240 240" fill="none">
        <defs>
          ...
          <radialGradient
            ...
            cy="0"
            r="1"
            gradientTransform="translate(120 120) rotate(90) scale(72)"
          >
